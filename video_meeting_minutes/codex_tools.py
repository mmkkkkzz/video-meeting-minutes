...
- 各トピック内は必ず「論点」「参加者の意見」「結果」の3項目で整理する。
- 「論点」には、そのトピックで何が問題・確認対象だったのかを書く。
- 「参加者の意見」には、誰がどのような見解・懸念・提案を出したかを書く。発言者が不明な場合は「参加者」または「担当者不明」と書く。
- 「結果」には、決定、持ち帰り、TODO化、未決のいずれになったかを書く。
